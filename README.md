...
🚧 **Pre-alpha.** Burlington Hydro (Ontario, Canada) is the first targeted utility; the proxy server is in Burlington Hydro's test lab.
...
| Utility | Status |
| --- | --- |
| Burlington Hydro (Ontario, Canada) | Pre-launch — in test lab |
